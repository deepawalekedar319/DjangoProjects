...
urlpatterns = [
    ...
    url(r'^side/$', views.side_view),
    url(r'^post/$', views.mypost_view),
    url(r'^my-uploads/(?P<id>\d+)/$', views.myupload_view),
	...
	url(r'^get-all-posts/$',views.allposts_view),
	url(r'^tag/(?P<tag_slug>[-\w]+)/$', views.home_view,name='post_list_by_tag_name'),
]